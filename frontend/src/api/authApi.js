...
export const authApi = {
  ...
  sendEmailOtp: (payload) => api.post("/auth/send-email-otp", payload).then((res) => res.data),
  verifyEmailOtp: (payload) => api.post("/auth/verify-email-otp", payload).then((res) => res.data),
